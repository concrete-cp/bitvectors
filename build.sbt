...
homepage := Some(url("https://github.com/concrete-cp/bitvectors"))

publishMavenStyle := true

pomExtra in Global := {
  <scm>
    <connection>scm:git:github.com/concrete-cp/bitvectors.git</connection>
    <url>github.com/concrete-cp/bitvectors.git</url>
  </scm>
